...
const Footer = () => {
  ...
  return (
    <footer className="bg-purple-500 border-purple-500 text-sm mt-6 font-body">
      <Container>
        <div className="flex flex-wrap justify-between py-16 mb-5">
          ...
          >
            <span className="text-4xl text-purple-200 lg:text-[2.5rem] font-bold tracking-tighter leading-tight lg:text-left mb-10 lg:mb-0 lg:pr-4 lg:w-1/2 hover:underline font-title">
              Accessibility First
            </span>
            <Logo />
          </Link>
