    ...
    <Layout>
      ...
      <Container>
        <section className="mt-16 mb-32">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-tight md:leading-none mb-12 text-center">{t('title')}</h1>
          <p className="text-3xl font-bold tracking-tighter leading-tight md:leading-none mb-12 text-center">
            {t('p1')}
            <Link href="/" className="text-blue-800 dark:text-blue-500">{t('p2')}</Link>
            {t('p3')}
          </p>
