...
const AccessibilityStatement = () => {
  return (
    <Layout>
      <Container>
        <h1 className="mt-16 text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-tight md:leading-none mb-12 text-center md:text-left">Accessibility Statement</h1>
