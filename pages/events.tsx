  ...
  return (
    <Layout>
      ...
      <Container>
        ...
        <section className="mt-16 mb-32 max-w-4xl dark:text-slate-800">
          ...
          <ul className="text-lg leading-relaxed my-6">
            {upcomingEvents.map((event, index) => (
              <li key={event.date} className={`${index % 2 !== 0 ? 'bg-yellow-200 dark:bg-yellow-500' : event.speaker === 'Julia' ? 'bg-blue-200 dark:bg-blue-500' : 'bg-purple-200 dark:bg-purple-500'
                ...
                <h3 className="text-2xl mt-6 mb-4 leading-snug font-semibold dark:text-inherit">{event.icon} {event.title} ({event.speaker})</h3>
