    ...
    <Layout>
      ...
      <Container>
        ...
        <section className="mb-32 max-w-4xl">
          ...
          <h2 className='text-3xl mt-12 mb-4 leading-snug font-bold text-center md:text-left'>{t('h2-3')}</h2>
          <p className="text-lg leading-relaxed my-6">
          {t('p5')}
          </p>
          <h3 className="text-2xl mt-8 mb-4 leading-snug font-semibold">{t('h3-1')}</h3>
          <p className="text-lg leading-relaxed my-6">
          {t('p6')}
          </p>
          <h3 className="text-2xl mt-8 mb-4 leading-snug font-semibold">{t('h3-2')}</h3>
          <p className="text-lg leading-relaxed my-6">
          {t('p7')}
          </p>
          <h3 className="text-2xl mt-8 mb-4 leading-snug font-semibold">{t('h3-3')}</h3>
          <p className="text-lg leading-relaxed my-6">
          {t('p8')}
          </p>
        </section>
